...
const Anabelle = () => {
  ...
  useEffect(() => {
    setIsLoading(true)
    axios('http://makeup-api.herokuapp.com/api/v1/products.json?brand=annabelle')
      ...
      <div className='product-cards'>
        {
            ...
            products.map(product => (
              <div className='product-cardcont' key={product.id}>
                <div className='blush-card' onClick={() => window.location.href = `/anabelle/${product.id}`}>
