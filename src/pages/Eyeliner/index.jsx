...
const Eyeliner = () => {
  ...
  useEffect(() => {
    setIsLoading(true)
    axios('http://makeup-api.herokuapp.com/api/v1/products.json?product_type=eyeliner')
        ...
        <div className='blush-cards'>
          {
            ...
            products.map(product => (
              <div className='product-cardcont' key={product.id}>
                <div className='blush-card' onClick={() => window.location.href = `/eyeliner/${product.id}`}>
